  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar elevation-4" style="background-color: #000080">
      ...
      <a href="{{url('/home')}}" class="brand-link">
        ...
        <span style="color:white; margin-left:15px" class="brand-text font-weight-bold"> <img style="margin-right: 8px;"
            width="60%" src="{{url('Main/images/logo.png')}}" alt="" /></span>
      </a>
      ...
      <div style="color:white" class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="{{asset('Images/'.$profile_pic)}}" class="img-circle elevation-2" alt="">
          </div>
          <div class="info">
